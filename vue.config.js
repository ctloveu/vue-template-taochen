...
// const CompressionWebpackPlugin = require('compression-webpack-plugin') // 开启压缩,需服务器对应开启压缩
const { HashedModuleIdsPlugin } = require('webpack')

// 引入配置文件
// login,
const { devIp, devPort, proxy, title, isProduction } = require('./src/settings.js')
...
module.exports = {
    ...
    * 详情：https：//cli.vuejs.org/config/#publicpath */
    ...
    devServer: {
        ...
        proxy: proxy // proxyTable: defaultSettings.proxy,
    },
