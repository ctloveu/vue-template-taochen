<template>
<!-- <div class="img-section" style="min-height: 10rem;">
                        ...
                        <ul class="img-ul">
                            <li class="img-ul-item" v-for="(item,index) in goodDetail.receiptImageUrls" :key="index" style="padding-bottom:10px">
                                <img-view :src="item" type="receipt"></img-view>
                            </li>
                        </ul>
                    </div> -->
<div class="receipt-main">
    <div class="receipt-main-simple">
        <div class="receipt-body">
            ...
            <div class="receipt-table">
                <div class="receipt-table-tr">
                    ...
                    <div class="receipt-table-td2" style="width: calc(100% - 1.5rem);">&nbsp;&nbsp;{{data.studentName}}</div>
                </div>
                <div class="receipt-table-tr">
                    <div class="receipt-table-td1">
                        <span>人</span>
                    ...
                    <div class="receipt-table-td3" style="width: 1.5rem;">（大写）</div>
                    <div class="receipt-table-td2" style="width: calc(55% - 1.7rem);">&nbsp;&nbsp;{{data.cashCapital}}</div>
                    <div class="receipt-table-td4" style="width: 0.4rem;">￥</div>
                    <div class="receipt-table-td2" style="width: calc(45% - 1.7rem);">&nbsp;&nbsp;{{data.amount}}</div>
                </div>
                <div class="receipt-table-tr">
                    <div class="receipt-table-td1">
                        <span>收</span>
                    ...
                    <div class="receipt-table-td2" style="width: calc(100% - 1.5rem);">&nbsp;&nbsp;{{paymentDetailShow(data.paymentDetails)}}</div>
                </div>
        ...
        <div class="end"><div style="margin-top: 3rem; text-align: center; height: 10rem;width: 100%;">第<br/>一<br/>联<br/>：<br/>客<br/>户</div></div>
    </div>
</div>
</template>
